...
class IoAsyncTask:
    ...
    __slots__ = [
        ...
        'condition', 'scheduler_lock',
        'scheduler_started', 'scheduler_stop_event', 'scheduler_threads',
        'event_loops',
        'idle_timers', 'idle_timeout', 'idle_timer_lock',
        'task_results', 'task_counters'
    ]
    ...
    def __init__(self) -> None:
        ...
        self.running_tasks: Dict[str, list[Any]] = {}  # Running tasks
    ...
    def _stop_scheduler(self,
        ...
        with self.scheduler_lock:
            ...
            if task_name in self.idle_timers:
                del self.idle_timers[task_name]
            if task_name in self.task_counters:
                del self.task_counters[task_name]
